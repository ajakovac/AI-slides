...
server_url = "http://localhost:8000/item/"
...
def create_html(database, key=None):
    sections = []
    for k in database:
        if k in ['linknumber']:
            continue
...
if __name__ == "__main__":
    ...
    parser.add_argument("--key", type=str, default=None, help="Generate HTML for this key")
    ...
    html_content = create_html(database, key=args.key)
