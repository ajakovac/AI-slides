- **General facts about AI**
    ...
    - **Market share and revenue**
        ...
        - ![Global AI market growth](../Images/global-AI-market-growth.png)
        - ![AI investment](../Images/AI-investment.png)
    - **Milestones**
        - __AI milestones__
    - **Challenges**
        - __AI challenges__
...
- **AI milestones**
    ...
    - **AlphaGo (DeepMind-Google)**
        - go program
        - Beat Lee Sedol in 2016 ![AlphaGo](../Images/alphago.png)
    - **LLMs, large language models**
        - NLP
        - transformer 2017
        - GPT models 2017-2022 ![chatGPT](../Images/chatGPT_illustration.png)
        - chatGPT 2022, added reinforcement learning and human feedback
    - **AlphaFold**
        - protein structure prediction ![AlphaFold](../Images/alphafold.png)
    - **image generation models**
        - 2021: DALL-E
        - 2023: Stable Diffusion![image](../Images/AI_generated_image_astronaut.png)
        - generative revolution
    - **multimodal systems and agentic coding**
        - 2024-2025: GPT-4 class multimodal systems ![multimodal](../Images/multimodal_systems.png)
...
- **AI challenges**
    ...
    - **Failures**
        - Unpredictable failures  ![panda vs gibbon](../Images/panda_vs_gibbon.png)
        - Hallucinations  ![three legged woman](../Images/three-legged-woman.png)
        - Vulnerability to adversarial attacks  ![STOP sign](../Images/stop_sign_adversarial.png)
...
- **🖼️ Popular AI Image Generators**
    ...
    - **Leonardo AI**
        ...
        - ![AI-generated-image](../Images/AI-generated-image.png)
